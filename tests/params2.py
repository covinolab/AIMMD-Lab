...
states_function = <function ParamsProperties.placeholder.<locals>.<lambda> at 0x7f6ce26d0940>
...
initial_paths = ["../../../../tmp/pytest-of-lazzeri/pytest-43/test_shoot_registers_completed0/shoot_initial.xtc"]
