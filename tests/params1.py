...
states_function = <function ParamsProperties.placeholder.<locals>.<lambda> at 0x7f6ce28eee60>
...
gmx_grompp = '/home/lazzeri/gromacs-2022/bin/gmx grompp -maxwarn 1'
...
gmx_mdrun = '/home/lazzeri/gromacs-2022/bin/gmx mdrun -v -maxh 4'
...
gmx_eneconv = 'printf "c\nc\n" | /home/lazzeri/gromacs-2022/bin/gmx -nobackup eneconv -settime'
...
from aimmd.network import placeholder as network
...
initial_paths = ["../../../../tmp/pytest-of-lazzeri/pytest-43/test_free_initializes_and_then0/free_initial.xtc"]
...
fit = <function default at 0x7f6ce288ed40>
