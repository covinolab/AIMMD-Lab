...
states_function = <function ParamsProperties.placeholder.<locals>.<lambda> at 0x7fd830fca7a0>
...
initial_paths = ["../../../tmp/pytest-of-lazzeri/pytest-45/test_shoot_registers_completed0/shoot_initial.xtc"]
